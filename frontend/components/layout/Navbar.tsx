...
export default function Navbar() {
  ...
  return (
    <>
      <nav 
        className={`fixed top-0 left-0 w-full transition-all duration-500 z-[100] px-10 lg:px-20 
          ${isScrolled 
            ? 'py-4 bg-white/80 backdrop-blur-xl shadow-[0_10px_40px_rgba(0,0,0,0.04)] border-b border-gray-100' 
            : 'py-8 bg-transparent'
          }`}
      >
        <div className="max-w-[1600px] mx-auto flex justify-between items-center">
          <Link href="/" className="group flex flex-col">
            ...
            <div className="h-[3px] w-8 bg-[#00A3AD] mt-0.5 rounded-full group-hover:w-full transition-all duration-500"></div>
          </Link>
          ...
          <div className="flex items-center gap-8 lg:gap-12">
            {user ? (
              ...
              <button 
                ...
                className={`text-[12px] font-black uppercase tracking-[0.2em] transition-all hover:text-[#00A3AD]
            ...
            <button 
              ...
              className={`px-8 py-3.5 rounded-2xl text-[12px] font-black transition-all shadow-2xl uppercase tracking-widest
      ...
      {!isHomePage && <div className="h-[100px]"></div>}
